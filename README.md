...
A minimal browser extension that shows your Claude.ai usage limits at a glance — session window, weekly caps per model, and extra usage spending — all using your existing browser session.
